<?php
   ...
   //Handling form submission to update payment status
   ...
   if (isset($_GET['delete'])) {
      //Retrieving order ID to be deleted
      ...
      //Redirecting to the admin orders page after deletion
   ...
   <section class="placed-orders">
      ...
      <div class="box-container">
         <?php
            ...
            $select_orders = mysqli_query($conn, "SELECT * FROM `confirmorder`WHERE paymentStatus = 'completed'") or die('query failed');
            if (mysqli_num_rows($select_orders) > 0) {
               //Looping through fetched orders
         ...
         ?>
                  ...
                  <div class="box">
                     ...
                     <form action="" method="post">
                        <input type="hidden" name="order_id" value="<?php echo $fetch_book['orderId']; ?>">Payment Status :
